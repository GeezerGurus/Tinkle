  ...
  return (
    ...
    >
      ...
      <Stack direction={"row"} gap={1}>
        <Typography variant={isSmallest?"h6":"h4"} sx={{ color: colors.extra.red_accent }}>
          DELETE
        </Typography>
      ...
      <Stack direction={"row"} alignItems={"baseline"} gap={1}>
        <Typography variant="body1" align="center">
          Do you really want to delete category <Typography display={"inline"} variant="h6">
          <b>{name}</b>?
        </Typography>
        </Typography>
      ...
      <Stack gap={1} direction={isSmallest?"column":"row"} justifyContent={"space-between"}>
        <Button
