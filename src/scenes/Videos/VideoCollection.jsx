...
import VideoContents from "../../components/utils/VideoContents"; // Ensure this is the correct path and export
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Typography textTransform="capitalize" variant="body1">Back</Typography>
        </Button>
      </Box>
      {/* Contents */}
      <Grid
